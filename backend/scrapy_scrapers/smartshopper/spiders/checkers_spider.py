"""
Checkers spider for Smart Shopper ZA
"""
            ...
            try:
                ...
                if product_link:
                    ...
                    if product_link.startswith('/'):
                        product_url = f"https://www.checkers.co.za{product_link}"
                ...
                if not product_url and product_id:
                    product_url = f"https://www.checkers.co.za/p/{product_id}"
